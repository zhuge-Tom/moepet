...
class PetManager:
    ...
    def _begin_streaming_local_tts(self, llm_streaming: bool) -> None:
        """Allow synthesis to overlap the streamed LLM reply."""
    ...
    def _on_llm_speech_ready(self, japanese_text: str) -> None:
        ...
        # Start the first complete protocol clause immediately. While it is
        # playing, its completion callback starts synthesizing the next one.
        self._start_next_bilingual_speech()
    ...
    def _start_next_bilingual_speech(self) -> None:
        ...
        if tts and getattr(tts, "is_busy", lambda: False)():
            ...
            return
        # Start small for low first-sound latency, then grow later requests so
        # synthesis finishes underneath already-playing audio.
